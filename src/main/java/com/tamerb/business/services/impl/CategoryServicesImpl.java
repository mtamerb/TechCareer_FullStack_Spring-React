package com.tamerb.business.services.impl;

import com.tamerb.bean.ModelMapperBean;
import com.tamerb.business.dto.CategoryDto;
import com.tamerb.business.services.ICategoryServices;
import com.tamerb.data.entity.CategoryEntity;
import com.tamerb.data.repository.ICategoryRepository;
import com.tamerb.exception.BlogNotFoundException;
import com.tamerb.exception.TamerBiliciException;
    ...
    public CategoryDto categoryServiceFind(Long id) {
        ...
        */
        ...
        if (id != null && id != 0) {
            ...
            throw new TamerBiliciException("Category id bull değerdir");
